...
- Reto técnico: Eliminar el abundante ARN ribosómico (ARNr), que representa la mayor parte del ARN en las muestras microbianas. Se utilizan técnicas de agotamiento de ARNr para enriquecer el ARNm y otros tipos de ARN.
