...
- Scripts: Incluye scripts y notebooks utilizados, permitiendo que el equipo reproduzca y continúe los análisis.
- Imagenes: Para guardar figuras y gráficos generados tras el analisis de datos
